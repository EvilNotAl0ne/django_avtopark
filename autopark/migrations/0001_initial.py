    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('black', 'Черный'), ('black', 'Черный'), ('black', 'Черный'), ('black', 'Черный'), ('black', 'Черный'), ('black', 'Черный')], max_length=20, verbose_name='Цвет')),
                ...
                ('category', models.CharField(choices=[('black', 'Черный'), ('black', 'Черный'), ('black', 'Черный'), ('black', 'Черный'), ('black', 'Черный')], max_length=20, verbose_name='Класс')),
